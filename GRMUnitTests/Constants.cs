namespace GRMUnitTests
{
    ...
    {
        public const string MusicContractsFileMock = @"Tinie Tempah|Frisky(Live from SoHo)|digital download, streaming|1st Feb 2012|
...
Monkey Claw|Christmas Special|streaming|25st Dec 2012|31st Dec 2012";
        public const string DistributionContractsFileMock = @"ITunes|digital download
YouTube|streaming";
    }
}
